...
#print(conjunto.intersection(conjunto2)) #{3, 5, 6, 9, '2'}
#print("metodo union",conjunto.union(conjunto2)) # {5,10,"2",3,6,9,} metodo union {2, 3, 5, 6, 8, 9, 10, '2'}
...
#print(lista1.copy())
#print(lista1.pop(2))
#print(lista1.append("último")) #None
#print(lista1)
...
#print(usuario1.get("nombre")) #Devuelve el valor de una clave especificada
